/**
 * ACP wire-content admission and projection.
 *
 * Copied verbatim from `@deepseek-ai/dsh-acp` (MIT) so this package can reuse the
 * prompt-admission and assistant-output projection without depending on the
 * official package's unexported internal module. See
 * packages/acp/acp/src/content.ts in the upstream repository.
 * @module dsh-acp-interactive/content
 */
