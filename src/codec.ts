 ...
 * stop-reason mapping without depending on the official package's unexported
 * internal module. See packages/acp/acp/src/codec.ts in the upstream repository.
 * @module dsh-acp-interactive/codec
 */
